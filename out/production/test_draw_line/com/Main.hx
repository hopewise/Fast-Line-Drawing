...
class Main extends Sprite
{
	...
	public function new() 
	{
		...
		var wave2:Wave = new Wave();

		var wave3:Wave = new Wave();
		var wave4:Wave = new Wave();
...
class Wave extends Sprite
{
    ...
    public var VirtualRAM:ByteArray;
	...
	#if (cpp || neko) 
	VirtualRAM.setLength((resX*resY + resX*resY) * 4);
	#else 
	VirtualRAM.length = (resX*resY + resX*resY) * 4;
	#end
